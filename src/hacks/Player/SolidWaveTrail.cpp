...
namespace eclipse::hacks::Player {
   ...
   class $modify(cocos2d::CCDrawNode) {    // Yes this is copied from Prism Menu I'm stupid to write it myself
       bool drawPolygon(cocos2d::CCPoint *p0, unsigned int p1, const ccColor4F &p2, float p3, const cocos2d::ccColor4F &p4) {
